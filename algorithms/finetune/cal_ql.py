...
def train(config: TrainConfig):
    ...
    print("=" * 70)
    print(f"Training Cal-QL (Finetune)")
    print("=" * 70)
    ...
    print(f"Batch size: {config.batch_size} (offline: {batch_size_offline}, online: {batch_size_online})")
    print(f"Evaluation frequency: {config.eval_freq:,} steps")
    print(f"CQL alpha (offline): {config.cql_alpha}, (online): {config.cql_alpha_online}")
    print("=" * 70)
